...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
     ...
     <form method="POST" action="?url=seguridad&opcion=modificarPass&redirec=configuracion">

      <div class="form-group">
        <label for="exampleInputPassword1">Contraseña actual:</label>
        <input type="text" class="form-control" id="passActual" name="passActual" placeholder="Respuesta" style="width:100%;">
      </div>
      <hr>
      <div class="form-group">
        <label for="exampleInputPassword1">Nueva contraseña:</label>
        <input type="text" class="form-control" id="passOne" name="passOne" placeholder="Ingrese su nueva contraseña" style="width:100%;">
      </div>
      <br>
      <div class="form-group">
        <label for="exampleInputPassword1">Confirme su contraseña:</label>
        <input type="text" class="form-control" id="passTwo" name="passTwo" placeholder="Confirme su nueva contraseña" style="width:100%;">
      </div>
      <br>
