            ...
            <form class="formulario_registrar" id="formulario" action="" method="POST">
              ...
              <label for="nombre_bono">Nombre del bono:</label>
                ...
                <span class="input-group-text" id="addon-wrapping"><i class="icon-payment"></i></span>
                  <input type="text" name="nombre_bono" id="id_nombre_bono" class="form-control" placeholder="Solos carácteres alfabéticos" aria-label="Solo carácteres numericos" aria-describedby="addon-wrapping" maxlength="50">
                </div>
              ...
              <div class="form-group">
                ...
                <div class="input-group flex-nowrap">
                  ...
                  <input type="number" name="valor" id="id_valor" class="form-control" placeholder="Solos carácteres numericos" aria-describedby="addon-wrapping" step=".01">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="input-group flex-nowrap">
                  ...
                  <input type="number" name="dias" id="id_dias" class="form-control" placeholder="Solos carácteres numericos" aria-describedby="addon-wrapping">
                </div>
            </div>
