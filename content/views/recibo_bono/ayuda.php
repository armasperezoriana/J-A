          ...
          <div class="modal-body">
            <form>
              <div class="form-group">
                ...
                <p> Se muestra una lista de todos los recibos de trabajos extras activos registrados en el sistema, Donde se puede generar PDF de ellos, registrar, modificar y eliminar.</p>
              </div>
            </form>
          </div>
