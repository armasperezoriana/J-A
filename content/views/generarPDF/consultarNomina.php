...
// contenido
    //MODELOS
        ...
        $pdf->Cell(30, 10, 'Horas extras',1, 0,'C', 0);
        ...
        foreach ($consultar as $datos) {
            ...
            $pdf->Cell(30,10, $datos['horas_extras'], 1, 0,'C', 0);
            $total_pagar = number_format($datos['total_pagar_nomina'], 2, ",", ".");
            $pdf->Cell(30,10, $total_pagar, 1, 0,'C', 0);
