          ...
          <div class="modal-body">
            <form>
              <div class="form-group">
                ...
                <p> Se muestra una lista de todos los cargos activos registrados en el sistema, con opciones de registrar un cargo nuevo, modificar uno existente o eliminar.</p>
              </div>
            </form>
          </div>
