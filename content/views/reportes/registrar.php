            ...
            <form class="formulario_registrar" id="formulario" action="" method="POST">
              <div class="form-group">
                ...
                <span class="input-group-text" id="addon-wrapping"><i class="icon-assignment"></i></span>
                  <input type="text" name="nombre_cargo" id="nombre_cargo" class="form-control" placeholder="Solos carácteres alfabéticos" aria-label="Solo carácteres numericos" aria-describedby="addon-wrapping">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="input-group flex-nowrap">
                  ...
                  <input type="number" name="sueldo_semanal" id="sueldo_semanal" class="form-control" placeholder="Solos carácteres numéricos" aria-label="Solo carácteres alfabéticos" aria-describedby="addon-wrapping" step=".01">
                </div>
              </div>
              <div class="form-group">
                <label for="prima_por_hogar">Prima por hogar:</label>
                <div class="input-group flex-nowrap">
                  <span class="input-group-text" id="addon-wrapping"><i class="icon-monetization_on"></i></span>
                  <input type="number" name="prima_por_hogar" id="prima_por_hogar" class="form-control" placeholder="Solos carácteres numéricos" aria-label="Solo carácteres alfabéticos" aria-describedby="addon-wrapping" step=".01">
                </div>
              </div>
          <br>
