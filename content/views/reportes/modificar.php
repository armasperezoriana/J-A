            ...
            <form class="formulario_modificar" id="formulario" action="" method="POST">
              ...
              <div class="form-group">
                ...
                <span class="input-group-text" id="addon-wrapping"><i class="icon-payment"></i></span>
                  <input value="<?php echo $datos['nombre_cargo'];?>" type="text" name="nombre_cargo_modificar" id="nombre_cargo_modificar" class="form-control" placeholder="Solos carácteres alfabéticos" aria-describedby="addon-wrapping">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="input-group flex-nowrap">
                  <span class="input-group-text" id="addon-wrapping"><i class="icon-monetization_on"></i></span>
                  <input value="<?php echo $datos['prima_por_hogar'];?>" type="number" name="prima_por_hogar" id="prima_por_hogar" class="form-control" placeholder="Solos carácteres numéricos" aria-describedby="addon-wrapping" step=".01">
                </div>
              </div>
          <br>
