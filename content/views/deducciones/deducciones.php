<!doctype html>
  ...
  <head>
    ...
    */
    td:nth-of-type(1):before { content: "Trabajador: "; }
    td:nth-of-type(2):before { content: "Cédula: "; }
    td:nth-of-type(3):before { content: "Desde: "; }
    td:nth-of-type(4):before { content: "Hasta: "; }
    td:nth-of-type(5):before { content: "Pago salario: "; }
  }
  ...
  <div class="d-flex">
      ...
      <section class="py-3" style="background-color: #F8F7F7;"> 
          <div class="container">
            <div class="row">
              ...
              <div class="col-lg-12 d-flex">
                ...
                <h2 class="font-weight-bold w-100 align-self-center" style="width: 100%;">Deducciones</h2>
                ...
                <div class="card rounded-0">
                  ...
                  <div class="card-body pt-2">
                      ...
                      <table class="table table-hover" id="tableID">
                              ...
                              <thead>
                                <tr align="center">
                                  <th scope="col">IVSS</th>
                                  <th scope="col">RPE</th>
                                  <th scope="col">FAOV</th>
                                  <th scope="col">ICES</th>
                                  <th scope="col">Modificar</th>
                                </tr>
                              </thead>
                              <tbody>
                               <?php $n=1; foreach ($consultarDeducciones as $datos) { ?>

                                <tr align="center">
                                  <td><?php echo $datos['ivss'] . ' %'; ?></td>                             
                                  <td><?php echo $datos['rpe'] . ' %'; ?></td>
                                  <td><?php echo $datos['faov'] . ' %'; ?></td>
                                  <td><?php echo $datos['inces'] . ' %'; ?></td>
                                  <td>                                     
        ...
        <!-- Modal modificar -->
                                <div class="modal fade" id="modificar<?php echo $n;?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                  <?php require 'content/views/deducciones/modificar.php'; ?> 
                                </div>
                                </tr>
              ...
              <center> <input type="button" onClick="document.location.href='?url=nomina'" value="VOLVER" class="btn btn-success darken-3 btn-small"></center>
          </div>
   ...
   <!-- Modal Ayuda -->
    <div class="modal fade" id="ayuda" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
     <?php require 'content/views/deducciones/ayuda.php'; ?> 
    </div>

    <?php $components->scripts(); ?>
    <script src="<?php echo _THEME_?>/js/AJAX/validaciones.js"></script>
    <script src="<?php echo _THEME_?>/js/AJAX/deducciones.js"></script>
