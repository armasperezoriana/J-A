                          ...
                          <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                            <div class="float-right" style="margin-top: 8px;" class="d-grid gap-2">
                                   ...
                                   <form action="?url=notificaciones&opcion=eliminarMsjEnviado&ruta=enviado" method="POST" id="eliminarMsj" name="eliminarMsj"> 
                                     ...
                                     <a href="?url=notificaciones&opcion=mensajesEnviados" data-position="bottom" data-tooltip="Actualizar buzón" class="btn btn-success pull-right" style="border-radius: 3em;"><i class="icon-refresh prefix"></i></a>
