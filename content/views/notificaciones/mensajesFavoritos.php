                        ...
                        <div class="row">
                          ...
                          <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                            <div class="float-right" style="margin-top: 8px;" class="d-grid gap-2">
                                   ...
                                   <form action="?url=notificaciones&opcion=eliminarMsj&ruta=favorito" method="POST" id="eliminarMsj" name="eliminarMsj"> 

                                      <a href="#" onclick="document.getElementById('eliminarMsj').action='?url=notificaciones&opcion=actualizarArchivar&ruta=favorito'; document.eliminarMsj.submit();" data-position="bottom" data-tooltip="Archivar mensajes seleccionados" class="btn btn-warning pull-right" style="border-radius: 3em;"><i class="icon-archive prefix"></i></a>
                                      ...
                                      <tbody>
                                        ...
                                        <?php if(!empty($consultarBuzon)){  foreach ($consultarBuzon as $buzon) { 
                                         ...
                                         <tr <?php if($buzon["leido"]=='1'){ ?> style="background: #EEEEEE;" <?php } ?> >
                                              ...
                                              <td><i type="button"  onClick="document.location.href='?url=notificaciones&opcion=actualizarFavorito&idMensaje=<?php echo $buzon["idNotificacion"];?>&ruta=favorito&setFav=1'" class="waves-effect waves-block waves-light icon-star_border"></i></td>
                                             
                                              <?php }else { ?>
                                            
                                              <td><i type="button" onClick="document.location.href='?url=notificaciones&opcion=actualizarFavorito&idMensaje=<?php echo $buzon["idNotificacion"];?>&ruta=favorito&setFav=0'"  class="waves-effect waves-block waves-light icon-star"></i></td>
                                              <?php } ?>
                                        ...
                                        <?php  } } } else { echo "<center> No hay mensajes favoritos su buzon </center>"; } ?>
